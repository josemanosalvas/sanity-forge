...
// Query: *[_type == "page" && defined(image)][0]{      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(alt, asset->altText, caption),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }.image
...
// Query: *[_type == "page" && site == $site && language == $locale && slug.current == $path][0]{    _id,    _type,    site,    language,    title,    description,    "slug": slug.current,      seoTitle,  seoDescription,  seoNoIndex,  ogTitle,  ogDescription,  "ogImage": coalesce(seoImage, image).asset->url + "?w=1200&h=630&fit=crop&fm=jpg&q=80",      "translations": *[_type == "translation.metadata" && references(^._id)][0]    .translations[defined(value)]{      language,      "site": value->site,      "slug": value->slug.current    }  }
